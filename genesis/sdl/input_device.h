...
static const std::map<int /* SDLK */, io_ports::key_type> default_key_layout = {
	...
	{ SDLK_w, io_ports::key_type::UP },
	{ SDLK_s, io_ports::key_type::DOWN },
	{ SDLK_a, io_ports::key_type::LEFT },
	{ SDLK_d, io_ports::key_type::RIGHT },

	{ SDLK_k, io_ports::key_type::A },
	{ SDLK_l, io_ports::key_type::B },
	{ SDLK_SPACE, io_ports::key_type::C },
};

class input_device : public io_ports::input_device
{
public:
	input_device(std::map<int /* SDLK */, io_ports::key_type> key_layout = default_key_layout)
